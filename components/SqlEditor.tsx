// sqlCompletions.ts
import { TableMetadata, useSQLite } from "@/hooks/useSqlite";
...
export function configureSqlCompletions(monaco: typeof Monaco, tables: TableMetadata[]) {
...
// In your component:
export default ({ onChange }: { onChange: (query: string | undefined) => void }) => {
  const { getTableMetadata } = useSQLite();
  //   if (monacoEl.current && !editor.current) {
  //     console.log("creating editor", monacoEl.current);
  ...
  //     const initializeCompletions = async () => {
  //       const tables = await getTableMetadata();
  //       console.log("tables", tables);
  //       configureSqlCompletions(Monaco, editor.current!, tables);
  //     };

  //     initializeCompletions();

  //     console.log("creating editor 2", editor.current);
  //   }
  ...
  return (
    <Editor
      ...
      defaultValue="SELECT * FROM players"
      onChange={onChange}
      options={{
